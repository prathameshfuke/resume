            ...
            <div className="w-full max-w-6xl mx-auto border-t border-white/10">
                ...
                <div className="py-4 md:py-8 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    {achievements.map((achievement, index) => (
                        <div
                            key={index}
                            className="bg-gradient-to-br from-yellow-900/30 to-orange-900/15 border border-yellow-500/20 rounded-xl p-4 md:p-6 hover:border-yellow-500/50 hover:shadow-lg hover:shadow-yellow-500/10 transition-all duration-300 group"
                        >
