...
export default function Cursor3D() {
    ...
    return (
        <>
            ...
            <div
                ref={ringRef}
                className="fixed top-0 left-0 pointer-events-none z-[9998] rounded-full border border-[#00E5FF]/60 bg-[#00E5FF]/10"
                style={{
                    ...
                    willChange: 'transform',
                    backfaceVisibility: 'hidden',
                    transition: 'width 0.15s ease-out, height 0.15s ease-out, border-color 0.15s ease'
                }}
            />
        </>
    )
